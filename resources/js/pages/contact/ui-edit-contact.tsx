...
export default function EditContact({ id, onClose }: EditContactProps) {
    ...
    const handleEditSubmit = (e: FormEvent) => {
        ...
        router.post('/edit-contact', form, {
            preserveScroll: true,

            onSuccess: () => {
                onClose();
                useAlert.getState().showAlert(
                    <Allert visible={true} type='success' message='Kontak Telah Di Edit' title='Berhasil Edit Kontak' />
                );
                setForm(prev => ({
                    ...prev,
                    name: "",
                ...
                setTimeout(() => {
                    useAlert.getState().showAlert(
                        <Allert visible={false} type='success' message='Kontak Telah Di Edit' title='Berhasil Edit Kontak' />
                    );
                }, 2000);
            },
            onError: () => {
